...
Widget appBarTitle = new Text("About",style: TextStyle(fontWeight: FontWeight.w800,color: AppTheme.appbar_title,fontSize: 17,));
            ...
            new IconButton(icon: actionIcon,onPressed:(){
              setState(() {
                if (actionIcon.icon == Icons.search){
                  ...
                  actionIcon = new Icon(Icons.search,color: AppTheme.AppBarTheme,);
                  appBarTitle = new Text("About",style: TextStyle(fontWeight: FontWeight.w800,color: AppTheme.appbar_title,fontSize: 17,));
                }
                ...
                child:SingleChildScrollView(
                 ...
                 Stack(
                  ...
                  children: <Widget>[
                    ...
                    decoration: BoxDecoration(
                    image: DecorationImage(
                      image:AssetImage("assets/images/about_detail.png"),
                      fit: BoxFit.cover,
                    )),
                      height: 210,width: 282,
                    )]),
