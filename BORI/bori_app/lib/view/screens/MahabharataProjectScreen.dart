...
Widget appBarTitle = new Text("Mahabharata Project",style: TextStyle(fontWeight: FontWeight.w800,color: AppTheme.appbar_title,fontSize: 17,));
              ...
              onPressed: () {
                setState(() {
                  if (actionIcon.icon == Icons.search) {
                    ...
                    appBarTitle = new Text("Mahabharata Project",style: TextStyle(fontWeight: FontWeight.w800,color: AppTheme.appbar_title,fontSize: 17,));
                  }
                });
              },
            ),
    ...
    Visibility(
                 visible: true,
                       child:Container(
                         ...
                         child: Text("Mahabharata Project",
                       ...
                       Visibility(
                         ...
                         child:Container(
                          ...
                          //   alignment: AlignmentDirectional.topStart,
                           child: Text("The details of the work \n published and underway:",
                             textAlign: TextAlign.center,
                             overflow: TextOverflow.ellipsis,
                             maxLines: 30,
                             style: TextStyle(
                       ...
                       Visibility(
                         ...
                         Container(
                           ...
                           child:Column(
                             ...
                             children: [
                           Text("(1) Critical Edition of the Mahabharata:", textAlign: TextAlign.start,
      overflow: TextOverflow.ellipsis,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w900),),
   Text("April 1919 to September 1966; 18 Parvan-s; 89000+ verses in the Constituted Text, and an elaborate Critical Apparatus; 19 Volumes: No. of pages: 15000+ demi-quarto size\n\n", textAlign: TextAlign.left,
     overflow: TextOverflow.ellipsis,
     maxLines: 30,
     style: TextStyle(
         color: AppTheme.deco,fontSize: 16,
    ...
    Text(" (2) Critical Edition of the Harivamsha:", textAlign: TextAlign.justify,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w900),),
    Text("1966 to 1969; 4 Parvan-s; 2 Volumes; No. of pages 1711 demi-quarto size\n\n", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
    ...
    Text(" (3) Pratika Index (Index of the verse quarters):", textAlign: TextAlign.justify,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w900),),
    Text(" 360000 verse quarters with appendices; 6 Volumes; 4805 pages; demi-quarto size\n\n", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
    ...
    Text("(4) Critically constituted text of Mahabharata and Harivamsha", textAlign: TextAlign.left,
        overflow: TextOverflow.ellipsis,
        maxLines: 30,
        style: TextStyle(
            color: AppTheme.deco,fontSize: 16,
            fontWeight: FontWeight.w900),),
    Text(" 5 volumes; 3150 pages demi-quarto size\n\n", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
    ...
    Text(" (5) Cultural Index:", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w900),),
    Text(" (a)	1987 till date; published 2 volumes;", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text(" Vol. I – 4 fascicules: Mountains, Rivers, Serpents, etc.; 400 pages; double crown size (Concise volume: pages vii+506)", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text(" Vol. II – 3 fascicules: Names of Countries, Peoples, Weapons, etc.; 360 pages double crown size", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text("Vol. III – (1st fascicule in progress): Proper names", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text(" (b)	Reference Cards: 1,50,000+ (15 cm X 10 cm); used 19,000+; unused 1,31,000\n\n", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
    ...
    Text(" (6) Bibliography of the Mahabharata:", textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w900),),
                           Text(" 6000+ entries recorded and categorized; Card Size 22 cm X 15 cm; 600 entries computerized\n\n", textAlign: TextAlign.left,
                             overflow: TextOverflow.ellipsis,
                             maxLines: 30,
                             style: TextStyle(
                                 color: AppTheme.deco,fontSize: 16,
                                 fontWeight: FontWeight.w500),),
                             Text(" (7) Mahabharata on CD-ROM:",  textAlign: TextAlign.start,
                             overflow: TextOverflow.ellipsis,
                             maxLines: 30,
                             style: TextStyle(
                                 color: AppTheme.deco,fontSize: 16,
                                 fontWeight: FontWeight.w900),),
                           Text(" The Constituted Text of the Critical Edition available on the CD-ROM with lead search, phrase search, and /or lead search.",
                             textAlign: TextAlign.left,
                             overflow: TextOverflow.ellipsis,
                             maxLines: 30,
                             style: TextStyle(
    ...
    child:Column(
      ...
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
                              Text("(1)Next steps in ongoing work:",textAlign: TextAlign.left,
                                overflow: TextOverflow.ellipsis,
                                maxLines: 30,
                                style: TextStyle(
                                    color: AppTheme.deco,fontSize: 16,
                                    fontWeight: FontWeight.w900),),
  Text("- Updating of reference cards should continue.",textAlign: TextAlign.left,
    overflow: TextOverflow.ellipsis,
    maxLines: 30,
    style: TextStyle(
        color: AppTheme.deco,fontSize: 16,
        fontWeight: FontWeight.w500),),
    Text("-	Compiling and editing of entries for the Cultural Index should continue.",textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text(" -	Printing Bibliography Data-cards according to the proforma.",textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text("-	Sending letters to Libraries world over for assistance in preparation of the Bibliography of Mahābhārata.",textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
    Text("-	Complete digitization of the Bibliography.",textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
                             Text("- Editing of the Bibliography.\n\n",textAlign: TextAlign.left,
                               overflow: TextOverflow.ellipsis,
                               maxLines: 30,
                               style: TextStyle(
                                   color: AppTheme.deco,fontSize: 16,
                             ...
                             Text("(2) Prospects of expansion:",textAlign: TextAlign.left,
                               overflow: TextOverflow.ellipsis,
                               maxLines: 30,
                               style: TextStyle(
                                   color: AppTheme.deco,fontSize: 16,
                                   fontWeight: FontWeight.w900),),
                             Text("-	Translation of the Critical Edition.",textAlign: TextAlign.left,
                               overflow: TextOverflow.ellipsis,
                               maxLines: 30,
                               style: TextStyle(
                                   color: AppTheme.deco,fontSize: 16,
                                   fontWeight: FontWeight.w500),),
                             Text("-	Interpretative Epilogue of Mahābhārata.",textAlign: TextAlign.left,
                               overflow: TextOverflow.ellipsis,
                               maxLines: 30,
                               style: TextStyle(
                                   color: AppTheme.deco,fontSize: 16,
                                   fontWeight: FontWeight.w500),),
                             Text("- Digitization of the Critical Apparatus.",textAlign: TextAlign.left,
      overflow: TextOverflow.ellipsis,
      maxLines: 30,
      style: TextStyle(
          color: AppTheme.deco,fontSize: 16,
          fontWeight: FontWeight.w500),),
                             Text("- Digitization of Cultural Index.",
          ...
          new Container(
            ...
            child: new Center(
              child: new Text(_item.buttonText,
                  style: new TextStyle(
                      color: _item.isSelected ? Colors.white : AppTheme.AppBarTheme,
            ...
            decoration: new BoxDecoration(
              ...
              border: new Border.all(
                  width: 2.0,
                  color: _item.isSelected ? AppTheme.AppBarTheme : AppTheme.AppBarTheme),
