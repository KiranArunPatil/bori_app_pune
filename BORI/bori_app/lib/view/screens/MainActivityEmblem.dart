...
class MainActivityEmblem extends StatefulWidget {
  @override
  _BottomBarState createState() => new _BottomBarState();
}

class _BottomBarState extends State<MainActivityEmblem> {
  late int _pageIndex =2;
  late PageController _pageController;

  List<Widget> tabPages = [HomeScreen(),MiddleScreen(),EmblemScreen()];
